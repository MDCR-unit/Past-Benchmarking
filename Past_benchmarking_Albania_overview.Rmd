...
knit: (function(input_file, encoding) {
 ...
 encoding=encoding,
 output_file=file.path(dirname(input_file), out_dir, 'Past_benchmarking_Albania_overview.html'))})
---


This is a summary of the results from the Past Benchmarking algorithm for the country Albania.
