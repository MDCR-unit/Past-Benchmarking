...
caps<-read_excel("0_Indicator_Tables/map_figures.xlsx")
emp <- read_excel("0_Indicator_Tables/2019_ALB_employ.xlsx")
names(emp)[2]<-"country"
...
caps<-read_excel("0_Indicator_Tables/map_figures.xlsx")
myr <- read_excel("0_Indicator_Tables/2019_ALB_meanyrs.xlsx")
names(myr)[2]<-"country"
...
myrs.output<- read_excel("0_Indicator_Tables/2019_ALB_meanyrs.xlsx")

myrs.output <- myrs.output[,-1]

DT::datatable(myrs.output, rownames = FALSE)

myrs.ts<- read_excel("0_Indicator_Tables/2010_ALB_myrs_ts.xlsx")
...
caps<-read_excel("0_Indicator_Tables/map_figures.xlsx")
nskool <- read_excel("0_Indicator_Tables/2019_ALB_noschool.xlsx")
...
caps<-read_excel("0_Indicator_Tables/map_figures.xlsx")
output <- read_excel("0_Indicator_Tables/2019_ALB_lab.xlsx")
